...
target_file = "/Users/wangxiaoman/Desktop/research/imgcrop-master/example/train_aug/"  # 修改后的文件地址
num = 50  # 产生图片次数
...
with tf.Session() as sess:
    for i in range(num):
        ...
        image_data = tf.image.convert_image_dtype(filpped_le_re, dtype=tf.uint8)
        ...
        with tf.gfile.GFile(target_file + file_list[a].split('.')[0] + "_enhance" +str(i) + ".jpeg", "wb") as f:
            f.write(encode_data.eval())
print("augmentation is over")
